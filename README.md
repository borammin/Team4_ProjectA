...
## Project Overview
* This project implements an event-driven data pipeline that automatically converts uploaded CSV files into JSON format using AWS services. When a file is uploaded to a specific S3 bucket, it automatically triggers a cloud function that processes the conversion, stores the output, and logs the metadata in a relational database.
---

## Installation/building

### 1. Storage Configuration 
Create 2 S3 buckets with the following directory structure:
* ds2002-team4-input
* ds2002-team4-output
...
3. Load: Uploads the serialized JSON data to the ds2002-team4-output.
